...
public class GameScreen implements Screen {
	...
	public Patch patch = new Patch(this);
	long tick = 0;
	...
	void drawFrame(int x, int y, int width, int height, boolean useBackground) {
	...
	void drawFont(int type, int X, int Y, String s, boolean centered, float scale, Color col) {
		float curX = X;
